...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_DCNF_SECURE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CTRLAP_SECURE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_UARTE2_SECURE, 1);
